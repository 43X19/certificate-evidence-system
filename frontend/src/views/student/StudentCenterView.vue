...
@media (max-width: 768px){.student-topbar{height:auto;min-height:62px;padding:10px 16px;gap:12px;flex-wrap:wrap}.student-main{padding:20px 14px 32px}.student-hero{align-items:stretch;flex-direction:column}.student-hero h1{font-size:28px}.student-search{width:100%}.student-metrics{grid-template-columns:1fr}.panel-title{align-items:flex-start;gap:12px;flex-direction:column}}
</style>
